...
#include <stddef.h>
#include "blas.h"
#include "EKF_SIL_02_newdelIps_sfun.h"
#include "c25_EKF_SIL_02_newdelIps.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "EKF_SIL_02_newdelIps_sfun_debug_macros.h"
...
static void initialize_c25_EKF_SIL_02_newdelIps
  (SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance);
static void initialize_params_c25_EKF_SIL_02_newdelIps
  (SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance);
static void enable_c25_EKF_SIL_02_newdelIps
  (SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance);
static void disable_c25_EKF_SIL_02_newdelIps
  (SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance);
static void c25_update_debugger_state_c25_EKF_SIL_02_newdelIps
  (SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c25_EKF_SIL_02_newdelIps
  (SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance);
static void set_sim_state_c25_EKF_SIL_02_newdelIps
  (SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance, const mxArray
   *c25_st);
static void finalize_c25_EKF_SIL_02_newdelIps
  (SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance);
static void sf_gateway_c25_EKF_SIL_02_newdelIps
  (SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance);
static void mdl_start_c25_EKF_SIL_02_newdelIps
  (SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance);
static void c25_chartstep_c25_EKF_SIL_02_newdelIps
  (SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance);
static void initSimStructsc25_EKF_SIL_02_newdelIps
  (SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance);
...
static const mxArray *c25_sf_marshallOut(void *chartInstanceVoid, void
  *c25_inData);
static void c25_emlrt_marshallIn(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, const mxArray *c25_b_Pd1, const char_T *c25_identifier, real_T
  c25_y[324]);
static void c25_b_emlrt_marshallIn(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
...
static const mxArray *c25_b_sf_marshallOut(void *chartInstanceVoid, void
  *c25_inData);
static void c25_c_emlrt_marshallIn(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, const mxArray *c25_b_xd, const char_T *c25_identifier, real_T
  c25_y[18]);
static void c25_d_emlrt_marshallIn(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, const mxArray *c25_u, const emlrtMsgIdentifier *c25_parentId,
  real_T c25_y[18]);
...
static const mxArray *c25_g_sf_marshallOut(void *chartInstanceVoid, void
  *c25_inData);
static real_T c25_e_emlrt_marshallIn(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, const mxArray *c25_u, const emlrtMsgIdentifier *c25_parentId);
...
static const mxArray *c25_h_sf_marshallOut(void *chartInstanceVoid, real_T
  c25_inData_data[], int32_T *c25_inData_sizes);
static void c25_f_emlrt_marshallIn(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, const mxArray *c25_u, const emlrtMsgIdentifier *c25_parentId,
...
static void c25_inv(SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance,
                    real_T c25_x_data[], int32_T c25_x_sizes[2], real_T
                    c25_y_data[], int32_T c25_y_sizes[2]);
static void c25_realmin(SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance);
static void c25_eps(SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance);
static void c25_eml_scalar_eg(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_dimagree(SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance);
static void c25_eml_switch_helper(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_eml_xgetrf(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
...
static void c25_check_forloop_overflow_error
  (SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance, boolean_T
   c25_overflow);
static int32_T c25_eml_ixamax(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, int32_T c25_n, real_T c25_x_data[], int32_T c25_x_sizes[2],
  int32_T c25_ix0);
static boolean_T c25_use_refblas(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_scalarEg(SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance);
static void c25_eml_xgeru(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
...
static void c25_below_threshold(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_eml_ipiv2perm(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, int32_T c25_ipiv_data[], int32_T c25_ipiv_sizes[2], int32_T
  c25_m, int32_T c25_perm_data[], int32_T c25_perm_sizes[2]);
static void c25_eml_xtrsm(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, int32_T c25_m, int32_T c25_n, real_T c25_A_data[], int32_T
...
static real_T c25_norm(SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance,
  real_T c25_x_data[], int32_T c25_x_sizes[2]);
static void c25_eml_warning(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_b_eml_warning(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, char_T c25_varargin_2[14]);
static void c25_b_eml_scalar_eg(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_eml_xgemm(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
...
static void c25_b_below_threshold(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_threshold(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_b_scalarEg(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_c_eml_scalar_eg(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_b_eml_xgemm(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
...
static void c25_c_below_threshold(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_c_scalarEg(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_d_scalarEg(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_d_eml_scalar_eg(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_c_eml_xgemm(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
...
static void c25_d_below_threshold(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_e_scalarEg(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_e_eml_scalar_eg(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_d_eml_xgemm(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, int32_T c25_n, int32_T c25_k, real_T c25_A_data[], int32_T
  ...
  c25_b_C_sizes[2]);
static void c25_e_below_threshold(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_f_eml_scalar_eg(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_e_eml_xgemm(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, int32_T c25_k, real_T c25_A_data[], int32_T c25_A_sizes[2],
  real_T c25_B[324], int32_T c25_ldb, real_T c25_C[324], real_T c25_b_C[324]);
static void c25_f_below_threshold(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_eye(SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance,
                    real_T c25_I[324]);
static void c25_g_eml_scalar_eg(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_f_eml_xgemm(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, int32_T c25_m, int32_T c25_n, int32_T c25_k, real_T
  ...
  [2]);
static void c25_g_below_threshold(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_h_eml_scalar_eg(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void c25_g_eml_xgemm(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, real_T c25_A[324], real_T c25_B[324], real_T c25_C[324],
  real_T c25_b_C[324]);
static void c25_g_emlrt_marshallIn(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, const mxArray *c25_sprintf, const char_T *c25_identifier,
  char_T c25_y[14]);
static void c25_h_emlrt_marshallIn(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, const mxArray *c25_u, const emlrtMsgIdentifier *c25_parentId,
  char_T c25_y[14]);
static const mxArray *c25_i_sf_marshallOut(void *chartInstanceVoid, void
  *c25_inData);
static int32_T c25_i_emlrt_marshallIn(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, const mxArray *c25_u, const emlrtMsgIdentifier *c25_parentId);
static void c25_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c25_mxArrayInData, const char_T *c25_varName, void *c25_outData);
static uint8_T c25_j_emlrt_marshallIn(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, const mxArray *c25_b_is_active_c25_EKF_SIL_02_newdelIps, const
  char_T *c25_identifier);
static uint8_T c25_k_emlrt_marshallIn(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, const mxArray *c25_u, const emlrtMsgIdentifier *c25_parentId);
static void c25_b_eml_xgetrf(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, int32_T c25_m, int32_T c25_n, real_T c25_A_data[], int32_T
  c25_A_sizes[2], int32_T c25_lda, int32_T c25_ipiv_data[], int32_T
  c25_ipiv_sizes[2]);
static void c25_b_eml_xgeru(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, int32_T c25_m, int32_T c25_n, real_T c25_alpha1, int32_T
  c25_ix0, int32_T c25_iy0, int32_T c25_incy, real_T c25_A_data[], int32_T
  c25_A_sizes[2], int32_T c25_ia0, int32_T c25_lda);
static void c25_b_eml_xtrsm(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, int32_T c25_m, int32_T c25_n, real_T c25_A_data[], int32_T
  c25_A_sizes[2], int32_T c25_lda, real_T c25_B_data[], int32_T c25_B_sizes[2],
  int32_T c25_ldb);
static void c25_h_eml_xgemm(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, int32_T c25_m, int32_T c25_k, real_T c25_A_data[], int32_T
  c25_A_sizes[2], int32_T c25_lda, real_T c25_B_data[], int32_T c25_B_sizes,
  int32_T c25_ldb, real_T c25_C_data[], int32_T *c25_C_sizes, int32_T c25_ldc);
static void c25_i_eml_xgemm(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, int32_T c25_n, real_T c25_A[324], real_T c25_B_data[], int32_T
  c25_B_sizes[2], real_T c25_C_data[], int32_T c25_C_sizes[2]);
static void c25_j_eml_xgemm(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, int32_T c25_k, real_T c25_A_data[], int32_T c25_A_sizes[2],
  real_T c25_B[6], int32_T c25_ldb, real_T c25_C[18]);
static void c25_k_eml_xgemm(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, int32_T c25_n, int32_T c25_k, real_T c25_A_data[], int32_T
  c25_A_sizes[2], real_T c25_B_data[], int32_T c25_B_sizes[2], int32_T c25_ldb,
  real_T c25_C_data[], int32_T c25_C_sizes[2]);
static void c25_l_eml_xgemm(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, int32_T c25_k, real_T c25_A_data[], int32_T c25_A_sizes[2],
  real_T c25_B[324], int32_T c25_ldb, real_T c25_C[324]);
static void c25_m_eml_xgemm(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, int32_T c25_m, int32_T c25_n, int32_T c25_k, real_T
  c25_A_data[], int32_T c25_A_sizes[2], int32_T c25_lda, real_T c25_B_data[],
  int32_T c25_B_sizes[2], int32_T c25_ldb, real_T c25_C_data[], int32_T
  c25_C_sizes[2], int32_T c25_ldc);
static void c25_n_eml_xgemm(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance, real_T c25_A[324], real_T c25_B[324], real_T c25_C[324]);
static void init_dsm_address_info(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc25_EKF_SIL_02_newdelIpsInstanceStruct
  *chartInstance);
  ...
  (SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc25_EKF_SIL_02_newdelIps(chartInstance);
    chart_debug_initialize_data_addresses(chartInstance->S);
  }

  chartInstance->c25_sfEvent = CALL_EVENT;
  _sfTime_ = sf_get_time(chartInstance->S);
  chartInstance->c25_is_active_c25_EKF_SIL_02_newdelIps = 0U;
}
  ...
  (SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance)
{
  ...
  c25_hoistedGlobal = chartInstance->c25_is_active_c25_EKF_SIL_02_newdelIps;
   ...
   *c25_st)
{
  ...
  chartInstance->c25_is_active_c25_EKF_SIL_02_newdelIps = c25_j_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(
       "is_active_c25_EKF_SIL_02_newdelIps", c25_u, 3)),
     "is_active_c25_EKF_SIL_02_newdelIps");
  sf_mex_destroy(&c25_u);
  c25_update_debugger_state_c25_EKF_SIL_02_newdelIps(chartInstance);
  ...
  (SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance)
{
  ...
  chartInstance->c25_sfEvent = CALL_EVENT;
  c25_chartstep_c25_EKF_SIL_02_newdelIps(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_EKF_SIL_02_newdelIpsMachineNumber_,
  ...
  *c25_inData)
{
  ...
  const mxArray *c25_y = NULL;
  SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance;
  chartInstance = (SFc25_EKF_SIL_02_newdelIpsInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c25_EKF_SIL_02_newdelIps_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c25_identifier)
{
  ...
  c25_y = c25_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c25_b_is_active_c25_EKF_SIL_02_newdelIps), &c25_thisId);
  sf_mex_destroy(&c25_b_is_active_c25_EKF_SIL_02_newdelIps);
  return c25_y;
}
...
void sf_c25_EKF_SIL_02_newdelIps_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c25_EKF_SIL_02_newdelIps_get_post_codegen_info(void);
mxArray *sf_c25_EKF_SIL_02_newdelIps_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c25_EKF_SIL_02_newdelIps_get_post_codegen_info();
...
mxArray *sf_c25_EKF_SIL_02_newdelIps_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c25_EKF_SIL_02_newdelIps_jit_fallback_info(void)
{
...
mxArray *sf_c25_EKF_SIL_02_newdelIps_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c25_EKF_SIL_02_newdelIps(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[11],T\"Pd1\",},{M[1],M[5],T\"U1\",},{M[1],M[10],T\"xd\",},{M[8],M[0],T\"is_active_c25_EKF_SIL_02_newdelIps\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c25_EKF_SIL_02_newdelIps_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc25_EKF_SIL_02_newdelIpsInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _EKF_SIL_02_newdelIpsMachineNumber_,
           25,
           1,
           1,
           0,
        ...
        init_script_number_translation(_EKF_SIL_02_newdelIpsMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_EKF_SIL_02_newdelIpsMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _EKF_SIL_02_newdelIpsMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c25_EKF_SIL_02_newdelIps(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc25_EKF_SIL_02_newdelIpsInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c25_EKF_SIL_02_newdelIps
    ((SFc25_EKF_SIL_02_newdelIpsInstanceStruct*) chartInstanceVar);
  initialize_c25_EKF_SIL_02_newdelIps((SFc25_EKF_SIL_02_newdelIpsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c25_EKF_SIL_02_newdelIps(void *chartInstanceVar)
{
  enable_c25_EKF_SIL_02_newdelIps((SFc25_EKF_SIL_02_newdelIpsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c25_EKF_SIL_02_newdelIps(void *chartInstanceVar)
{
  disable_c25_EKF_SIL_02_newdelIps((SFc25_EKF_SIL_02_newdelIpsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c25_EKF_SIL_02_newdelIps(void *chartInstanceVar)
{
  sf_gateway_c25_EKF_SIL_02_newdelIps((SFc25_EKF_SIL_02_newdelIpsInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c25_EKF_SIL_02_newdelIps(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c25_EKF_SIL_02_newdelIps
    ((SFc25_EKF_SIL_02_newdelIpsInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c25_EKF_SIL_02_newdelIps(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c25_EKF_SIL_02_newdelIps
    ((SFc25_EKF_SIL_02_newdelIpsInstanceStruct*)chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c25_EKF_SIL_02_newdelIps(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc25_EKF_SIL_02_newdelIpsInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_EKF_SIL_02_newdelIps_optimization_info();
    }

    finalize_c25_EKF_SIL_02_newdelIps((SFc25_EKF_SIL_02_newdelIpsInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc25_EKF_SIL_02_newdelIps
    ((SFc25_EKF_SIL_02_newdelIpsInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c25_EKF_SIL_02_newdelIps(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c25_EKF_SIL_02_newdelIps
      ((SFc25_EKF_SIL_02_newdelIpsInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c25_EKF_SIL_02_newdelIps(SimStruct *S)
{
  ssMdlUpdateIsEmpty(S, 1);
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_EKF_SIL_02_newdelIps_optimization_info();
...
static void mdlRTW_c25_EKF_SIL_02_newdelIps(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c25_EKF_SIL_02_newdelIps(SimStruct *S)
{
  SFc25_EKF_SIL_02_newdelIpsInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc25_EKF_SIL_02_newdelIpsInstanceStruct *)utMalloc(sizeof
    (SFc25_EKF_SIL_02_newdelIpsInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc25_EKF_SIL_02_newdelIpsInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c25_EKF_SIL_02_newdelIps;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c25_EKF_SIL_02_newdelIps;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c25_EKF_SIL_02_newdelIps;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c25_EKF_SIL_02_newdelIps;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c25_EKF_SIL_02_newdelIps;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c25_EKF_SIL_02_newdelIps;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c25_EKF_SIL_02_newdelIps;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c25_EKF_SIL_02_newdelIps;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c25_EKF_SIL_02_newdelIps;
  chartInstance->chartInfo.mdlStart = mdlStart_c25_EKF_SIL_02_newdelIps;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c25_EKF_SIL_02_newdelIps;
...
void c25_EKF_SIL_02_newdelIps_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c25_EKF_SIL_02_newdelIps(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c25_EKF_SIL_02_newdelIps(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c25_EKF_SIL_02_newdelIps(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c25_EKF_SIL_02_newdelIps_method_dispatcher.\n"
