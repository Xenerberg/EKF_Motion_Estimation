...
static void initialize_c7_Model_02_2014a(SFc7_Model_02_2014aInstanceStruct
  *chartInstance);
static void initialize_params_c7_Model_02_2014a
  (SFc7_Model_02_2014aInstanceStruct *chartInstance);
static void enable_c7_Model_02_2014a(SFc7_Model_02_2014aInstanceStruct
  *chartInstance);
static void disable_c7_Model_02_2014a(SFc7_Model_02_2014aInstanceStruct
  *chartInstance);
static void c7_update_debugger_state_c7_Model_02_2014a
  (SFc7_Model_02_2014aInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_Model_02_2014a
  (SFc7_Model_02_2014aInstanceStruct *chartInstance);
static void set_sim_state_c7_Model_02_2014a(SFc7_Model_02_2014aInstanceStruct
  *chartInstance, const mxArray *c7_st);
static void finalize_c7_Model_02_2014a(SFc7_Model_02_2014aInstanceStruct
  *chartInstance);
static void sf_gateway_c7_Model_02_2014a(SFc7_Model_02_2014aInstanceStruct
  *chartInstance);
static void c7_chartstep_c7_Model_02_2014a(SFc7_Model_02_2014aInstanceStruct
  *chartInstance);
static void initSimStructsc7_Model_02_2014a(SFc7_Model_02_2014aInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber, uint32_T c7_instanceNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static void c7_emlrt_marshallIn(SFc7_Model_02_2014aInstanceStruct *chartInstance,
  const mxArray *c7_Q_r, const char_T *c7_identifier, real_T c7_y[36]);
static void c7_b_emlrt_marshallIn(SFc7_Model_02_2014aInstanceStruct
...
static const mxArray *c7_d_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static real_T c7_c_emlrt_marshallIn(SFc7_Model_02_2014aInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static const mxArray *c7_e_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_d_emlrt_marshallIn(SFc7_Model_02_2014aInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  real_T c7_y[9]);
static void c7_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static void c7_e_emlrt_marshallIn(SFc7_Model_02_2014aInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  real_T c7_y[3]);
...
static void c7_fn_Create_Q_r11(SFc7_Model_02_2014aInstanceStruct *chartInstance,
  real_T c7_phi_r12[9], real_T c7_J[9], real_T c7_t_delta, real_T c7_tau, real_T
  c7_Q_r11[9]);
static void c7_mpower(SFc7_Model_02_2014aInstanceStruct *chartInstance, real_T
                      c7_a[9], real_T c7_c[9]);
static void c7_eml_scalar_eg(SFc7_Model_02_2014aInstanceStruct *chartInstance);
static void c7_eml_xgemm(SFc7_Model_02_2014aInstanceStruct *chartInstance,
...
static const mxArray *c7_f_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static int32_T c7_f_emlrt_marshallIn(SFc7_Model_02_2014aInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static uint8_T c7_g_emlrt_marshallIn(SFc7_Model_02_2014aInstanceStruct
  *chartInstance, const mxArray *c7_b_is_active_c7_Model_02_2014a, const char_T *
  c7_identifier);
static uint8_T c7_h_emlrt_marshallIn(SFc7_Model_02_2014aInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_b_eml_xgemm(SFc7_Model_02_2014aInstanceStruct *chartInstance,
  real_T c7_A[9], real_T c7_B[9], real_T c7_C[9]);
static void init_dsm_address_info(SFc7_Model_02_2014aInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_Model_02_2014a = 0U;
}
  ...
  (SFc7_Model_02_2014aInstanceStruct *chartInstance)
{
  ...
  c7_hoistedGlobal = chartInstance->c7_is_active_c7_Model_02_2014a;
  ...
  *chartInstance, const mxArray *c7_st)
{
  ...
  chartInstance->c7_is_active_c7_Model_02_2014a = c7_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 1)),
     "is_active_c7_Model_02_2014a");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_Model_02_2014a(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c7_sfEvent = CALL_EVENT;
  c7_chartstep_c7_Model_02_2014a(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_Model_02_2014aInstanceStruct *chartInstance;
  chartInstance = (SFc7_Model_02_2014aInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c7_Model_02_2014a_get_eml_resolved_functions_info(void)
{
  ...
  c7_identifier)
{
  ...
  c7_y = c7_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_Model_02_2014a), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_Model_02_2014a);
  return c7_y;
}
...
void sf_c7_Model_02_2014a_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c7_Model_02_2014a_get_autoinheritance_info(void)
{
...
mxArray *sf_c7_Model_02_2014a_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c7_Model_02_2014a_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c7_Model_02_2014a(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Q_r\",},{M[8],M[0],T\"is_active_c7_Model_02_2014a\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_Model_02_2014a_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc7_Model_02_2014aInstanceStruct *)
...
static void sf_opaque_initialize_c7_Model_02_2014a(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_Model_02_2014aInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_Model_02_2014a((SFc7_Model_02_2014aInstanceStruct*)
    chartInstanceVar);
  initialize_c7_Model_02_2014a((SFc7_Model_02_2014aInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c7_Model_02_2014a(void *chartInstanceVar)
{
  enable_c7_Model_02_2014a((SFc7_Model_02_2014aInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c7_Model_02_2014a(void *chartInstanceVar)
{
  disable_c7_Model_02_2014a((SFc7_Model_02_2014aInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c7_Model_02_2014a(void *chartInstanceVar)
{
  sf_gateway_c7_Model_02_2014a((SFc7_Model_02_2014aInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c7_Model_02_2014a(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_Model_02_2014a
    ((SFc7_Model_02_2014aInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c7_Model_02_2014a();/* state var info */
...
extern void sf_internal_set_sim_state_c7_Model_02_2014a(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c7_Model_02_2014a();/* state var info */
  ...
  set_sim_state_c7_Model_02_2014a((SFc7_Model_02_2014aInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c7_Model_02_2014a(SimStruct* S)
{
  return sf_internal_get_sim_state_c7_Model_02_2014a(S);
}

static void sf_opaque_set_sim_state_c7_Model_02_2014a(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c7_Model_02_2014a(S, st);
}

static void sf_opaque_terminate_c7_Model_02_2014a(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_Model_02_2014aInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c7_Model_02_2014a((SFc7_Model_02_2014aInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc7_Model_02_2014a((SFc7_Model_02_2014aInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_Model_02_2014a(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c7_Model_02_2014a(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c7_Model_02_2014a(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_Model_02_2014a(SimStruct *S)
{
  SFc7_Model_02_2014aInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc7_Model_02_2014aInstanceStruct *)utMalloc(sizeof
    (SFc7_Model_02_2014aInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_Model_02_2014aInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_Model_02_2014a;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_Model_02_2014a;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_Model_02_2014a;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c7_Model_02_2014a;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c7_Model_02_2014a;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_Model_02_2014a;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_Model_02_2014a;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_Model_02_2014a;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_Model_02_2014a;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_Model_02_2014a;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c7_Model_02_2014a;
...
void c7_Model_02_2014a_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_Model_02_2014a(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_Model_02_2014a(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_Model_02_2014a(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_Model_02_2014a_method_dispatcher.\n"
